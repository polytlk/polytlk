...
export const getAllauthClientV1AuthSession200Response = zod.object({
  status: zod.number(),
  data: zod.object({
    user: zod.object({
...
export const getAllauthClientV1AuthSession401Response = zod.object({
  status: zod.number(),
  data: zod.object({
    flows: zod.array(
      zod.object({
...
export const getAllauthClientV1AuthSession410Response = zod.object({
  status: zod.number(),
  data: zod.object({}),
  meta: zod
    .object({
...
export const deleteAllauthClientV1AuthSession401Response = zod.object({
  status: zod.number(),
  data: zod.object({
    flows: zod.array(
      zod.object({

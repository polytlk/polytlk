...
export const handlers = [
  ...
  rest.get('/task/af39f6f9-fa0c-4b9d-86c3-4804b2a3ffb0/stream', (req, res, ctx) => {
    return res(
      ctx.status(200),
